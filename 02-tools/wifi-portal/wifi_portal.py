...
Hardware: ReSpeaker 2-mic button — TTP223 touch sensor, active HIGH (GPIO13),
APA102 LEDs via SPI.
"""
import os
import subprocess
...
# --- Button ---
# pull_up=False: internal pull-down. The TTP223 drives the line itself
# (active HIGH — LOW idle, HIGH when touched), not a switch-to-ground.
try:
    _button = Button(BUTTON_PIN, pull_up=False)
