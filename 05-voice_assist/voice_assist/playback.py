...
RATE      = 48000
BLOCKSIZE = 2048  # ~43ms/callback — more headroom against scheduling jitter
                  # (was 1024/~21ms; caused occasional "output underflow").
                  # Cost is imperceptible next to Gemini's network latency.
