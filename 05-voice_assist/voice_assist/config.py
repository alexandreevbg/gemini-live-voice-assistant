...
# ── Wake Word (microWakeWord only) ──────────────────────────────────────
# Detection threshold lives in the JSON manifest's "probability_cutoff"
# field (per-model calibrated), not here.
WAKEWORD_MODEL   = '/home/chochko/voice_assist/models/chochko.json'
...
# ── Hardware ──────────────────────────────────────────────
BUTTON_PIN       = 13   # unused here (button.py has its own copy) — kept in sync for reference
LINE_DAC         = 66